...
void MCAL_UART_SendData	(USART_TypeDef *USARTx, uint8_t *pTxBuffer,enum Polling_mechism PollingEn );
void MCAL_UART_ReceiveData	(USART_TypeDef *USARTx, uint8_t *pTxBuffer ,enum Polling_mechism PollingEn );
