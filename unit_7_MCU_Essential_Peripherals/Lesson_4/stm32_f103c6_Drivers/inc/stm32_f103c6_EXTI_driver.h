...
typedef struct
{
	...
	uint8_t           IRQ_EN;       /*  Enable or Disable The EXTI IRQ (That will enable IRQ mask in EXTI and Also on the NVIC Interrupt controller )
...
#define EXTI_Trigger_RisingGAndFalling    2
...
#endif /* INC_STM32_F103C6_EXTIs_DRIVER_H_ */
